        ...
        <html>
            ...
            <body>
                <div class="parentFlex">
                    ...
                    <div><h2 class="OpenSans700">Conferma dell'account</h2></div>
                </div>
                <p>Gentile utente,</p>
                <p>Grazie per aver creato un account. Per completare la registrazione, dobbiamo verificare che questo indirizzo e-mail sia valido.</p>
                <p>Fai clic su <a href="{//confirmURL}">questo link</a> o sul pulsante seguente per confermare il tuo indirizzo e-mail:</p>
                <a href="{//confirmURL}" class="buttonConfirm" target="_blank">
                    <span class="innerButtonConfirm"><span style="font-size: 16px; line-height: 28px;"><span style="font-size: 14px; line-height: 25px; color: #ffffff;">Conferma il mio indirizzo e-mail</span></span></span>
                </a>
                <p>Se non hai richiesto questa e-mail, ignorala e l'account non verrà attivato.</p>
