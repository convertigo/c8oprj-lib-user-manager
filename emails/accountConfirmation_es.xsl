            ...
            <body>
                <div class="parentFlex">
                    <div class="selfCenter parentFlex" style="margin-right: 20px">
                        <img style="display: block; margin: auto;max-width:50px" src="{//logo}" />
                    </div>
                    <div><h2 class="OpenSans700">Confirmación de la cuenta</h2></div>
                </div>
                <p>Estimado usuario:</p>
                <p>Gracias por crear una cuenta con nosotros. Para completar el registro, debemos verificar que esta dirección de correo electrónico sea válida.</p>
                <p>Haz clic en <a href="{//confirmURL}">este enlace</a> o en el botón siguiente para confirmar tu dirección de correo electrónico:</p>
                <a href="{//confirmURL}" class="buttonConfirm" target="_blank">
                    <span class="innerButtonConfirm"><span style="font-size: 16px; line-height: 28px;"><span style="font-size: 14px; line-height: 25px; color: #ffffff;">Confirmar mi correo electrónico</span></span></span>
                </a>
                <p>Si no solicitaste este correo, ignóralo y la cuenta no se activará.</p>
